...
//        System.out.println("Buffer: " + pcm.size());
    ...
    // when
//    byte[] wavBytes = decodeFromMp3(mp3TestFile);
    File temp = File.createTempFile("audio_lame_mem_", ".wav");
//    Files.write(temp.toPath(), wavBytes);
    System.out.println(temp.getAbsolutePath());
    writeToFile(wavBytes, temp.getAbsolutePath()); // Just for the records...
  ...
  private byte[] asWav(byte[] pcmBytes, int sampleRate, int channels) throws IOException {
    System.out.println("Got to make wav");
